<#**************************************************************************************************
Name: Install-OracleUtils.ps1           Author: Brendan Furey                      Date: 03-Jan-2025
...
Install script copies module to Powershell path.

**************************************************************************************************#>
Import-Module ..\Utils\Utils.psm1
Install-Module $PSScriptRoot 'OracleUtils'
