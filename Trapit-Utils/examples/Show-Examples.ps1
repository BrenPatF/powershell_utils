...
Main driver for examples of use, which calls only the Write-UT_Template function from Trapit-Utils.

The other two entry point functions, Get-UT_TemplateObject and Test-Unit, have examples of use in
the unit test script Test-GetUT_TemplateObject.ps1 and in the function Write-UT_Template,
respectively.
